...
export const buttonStyles = {
  heroPrimary: cn(
    ...
    ctaPad,
    ctaLabel,
    "text-on-brand transition-transform md:hover:scale-105 active:scale-[1.02]",
    focusRing,
    disabledStates,
  ),
  heroSecondaryDark: cn(
    ...
    ctaPad,
    ctaLabel,
    "text-white transition-colors md:hover:bg-white/10 active:bg-white/10",
    focusRing,
    disabledStates,
  ),
  ...
  headerPill: cn(
    ...
    ctaLabel,
    "text-on-brand shadow-sm transition-transform md:hover:scale-[1.02] active:scale-[0.98]",
    focusRing,
    disabledStates,
  ),
  ...
  bookingPrimary: cn(
    ...
    ctaPad,
    ctaLabel,
    "text-on-brand shadow-brand-glow transition-transform md:hover:scale-105 active:scale-[1.02]",
    focusRing,
    disabledStates,
  ),
  blockBrand: cn(
    ...
    ctaLabel,
    "text-on-brand transition-all md:hover:scale-[1.02] active:scale-[0.98]",
    focusRing,
    disabledStates,
  ),
  blockBrandPricing: cn(
    "inline-flex w-full cursor-pointer items-center justify-center bg-brand px-6 py-5 md:px-8",
    ctaLabel,
    "text-on-brand transition-colors md:hover:bg-brand-hover active:bg-brand-hover",
    focusRing,
    disabledStates,
  ),
  blockOutline: cn(
    ...
    ctaLabel,
    "text-foreground transition-all md:hover:border-brand md:hover:text-brand active:border-brand active:text-brand",
    focusRing,
    disabledStates,
  ),
  formSubmit: cn(
    ...
    ctaPad,
    ctaLabel,
    "text-on-brand shadow-lg shadow-blue-900/10 transition-all md:hover:opacity-90 active:scale-[0.98]",
    focusRing,
    disabledStates,
  ),
} as const;
