    ...
    <section id="portfolio" className="bg-white py-24 md:py-32">
      <Container>
        ...
        <div className="group relative aspect-video w-full cursor-ew-resize overflow-hidden rounded-xl">
          ...
          <div className="absolute top-1/2 left-1/2 z-20 flex h-12 w-12 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full bg-brand text-on-brand shadow-2xl transition-transform duration-300 ease-out group-hover:scale-125">
